...
public class AdminAppApplication {
    ...
    CommandLineRunner runner(){
      return args -> {
          ...
          Permission per4 = new Permission("CUD Event");
          perRepository.save(per4);
          Permission per5 = new Permission("View User");
          perRepository.save(per5);
          Permission per6 = new Permission("CUD User");
          perRepository.save(per6);
          Permission per7 = new Permission("View Role");
          perRepository.save(per7);
          Permission per8 = new Permission("CUD Role");
          perRepository.save(per8);
          Permission per9 = new Permission("View Actions");
          perRepository.save(per9);
          Permission per10 = new Permission("CUD Action");
          perRepository.save(per10);
          Permission per11 = new Permission("View Events");
          perRepository.save(per11);
